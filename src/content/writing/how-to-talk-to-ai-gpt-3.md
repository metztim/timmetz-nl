---
title: "How to talk to an AI and get the results you want (Part 1)"
description: "Learn how to use OpenAI’s GPT-3 to make you more productive and creative (with free templates and examples to get you started)."
pubDate: 2023-01-28
sourceName: "Saent"
tags: ["saent"]
---
...
## Template #1: [The Expert Generator](https://weeatrobots.substack.com/p/prompt-the-expert-generator)
...
![https://userlist-production.s3.amazonaws.com/70b75ca9e1e481a5ee76c351b3d01f4cedfff9dcadf2bc88f735768a5e6ea6f9.jpg](/images/saent/how-to-talk-to-ai-gpt-3/63d26a35ab81019d58c0f228_70b75ca9e1e481a5ee76c351b3d01f4cedfff9dcadf2bc88f735768a5e6ea6f9.webp)
...
![https://userlist-production.s3.amazonaws.com/ebc20bd4c1874de82bcc447d03d483bf506ec0f3e1ba25a92a176eec12432ffb.jpg](/images/saent/how-to-talk-to-ai-gpt-3/63d26a35cd22060c4ff3d161_ebc20bd4c1874de82bcc447d03d483bf506ec0f3e1ba25a92a176eec12432ffb.webp)
...
## Template #2: [Improve a draft email or article based on feedback](https://www.timmetz.nl/Improve-draft-email-or-article-based-on-reader-feedback-basic-e86e5d3b3c46451fa250581a7b15e4b8)
...
2.  Rewrite the text for us based on those action points.

Here’s the template:

![https://userlist-production.s3.amazonaws.com/853d952c82a976aeda824cacf2036d1629d2680e14f7584e290923ed4bdd9533.jpg](/images/saent/how-to-talk-to-ai-gpt-3/63d26a37ab81014008c0f500_853d952c82a976aeda824cacf2036d1629d2680e14f7584e290923ed4bdd9533.webp)

[_See this template in action here_](https://www.timmetz.nl/Improve-draft-email-or-article-based-on-reader-feedback-basic-e86e5d3b3c46451fa250581a7b15e4b8)_. Scroll down to the Example section to see a draft I wrote, the extensive comments someone sent me, and how GPT-3 does a great job summarizing that feedback and rewriting the newsletter._
...
2.  Let the AI help bridge knowledge gaps by asking it qualifying questions about a topic or skill.

3.  Send the AI in a specific direction to prevent bland output.

4.  Create rules by explaining them to the AI in plain English.

5.  Break requests into multiple steps instead of trying with one perfect prompt.

## How to use GPT-3 and these templates? 🤷‍♀️

To use these templates or make your own, go to [OpenAI's GPT-3 Playground](https://beta.openai.com/playground) and follow these steps:

1.  Create a free OpenAI account.

2.  Copy the text from the top of the template to the line above the first orange box that says "🤖 Start AI," and paste it into the Playground's input window.

3.  Complete any sections marked in yellow that require your input.

4.  Place your cursor after the last text character without leaving a space.

5.  Press the _Shift_ + _Enter_ keys on your keyboard, or click the _Submit_ button.

6.  Wait for GPT-3 to produce its output.

7.  Delete any output from GPT-3 that’s unnecessary or irrelevant.

8.  If applicable, copy and paste the second part of the template into the Playground input window. Start after the first placeholder for AI output and stop before the second orange box.

9.  Fill in the sections marked in yellow that need your input.

10.  Repeat from step 4 until there are no orange boxes with AI starts left.
...
**Please share with me what you create, and send me comments or ideas for improving** [**these and other templates**](https://weeatrobots.substack.com/)**.** Just [reach out on Twitter](https://twitter.com/timmetz).
